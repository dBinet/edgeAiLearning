...
y_all_zeros = np.zeros(len(y_test), dtype=int)
print(f"Dumb model accuracy: {np.mean(y_all_zeros == y_test):.4f}")
print(f"Dumb model F1: {f1_score(y_test, y_all_zeros, zero_division=0):.4f}")
